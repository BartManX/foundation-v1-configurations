...
// ProcyonCoin Configuration File
...
const config = {};
config.enabled = true;
config.name = 'Pool-ProcyonCoin';
config.coins = ['ProcyonCoin'];
...
// Coin Configuration
config.primary.coin = {};
config.primary.coin.name = 'ProcyonCoin';
config.primary.coin.symbol = 'PRCO';
...
config.primary.coin.mainnet.peerMagic = '5052434F';
...
config.primary.coin.testnet.coin = 'tprco';
...
config.primary.payments.daemon.port = 7332;
