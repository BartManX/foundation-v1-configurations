...
const config = {};
config.enabled = true;
config.name = 'Pool-Meowcoin';
config.coins = 'Meowcoin';
...
config.primary.coin.mainnet.peerMagic = '4d455743';
config.primary.coin.mainnet.pubKeyHash = Buffer.from('32', 'hex').readUInt8(0);
...
config.primary.coin.mainnet.coin = 'mewc';
...
config.primary.coin.testnet.peerMagic = '6d657763';
config.primary.coin.testnet.pubKeyHash = Buffer.from('6D', 'hex').readUInt8(0);
...
config.primary.coin.testnet.coin = 'tmewc';
...
config.primary.payments.daemon.port = 8788;
